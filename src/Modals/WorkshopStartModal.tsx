...
const StartWorkshopModal: FC<props> = ({isShow, details, toggleModal}) => {
      ...
      <>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={[styles.descText, {color: theme.TEXT_COLOR}]}>
            An email has been sent to you, workshop speaker and all the workshop
            attendees containing meeting link and other instructions.{'\n'}
